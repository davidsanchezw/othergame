...
/**
 * Servlet que muestra los anuncios completados
 *
 */
@WebServlet("/adsCompleted")
public class AdsCompleted extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (me == null) {
			...
			try (DBManager db = new DBManager()) {
				...
				List<Ads> myAds = adDb.getUserAds(me.getId(), 3);
			...
			RequestDispatcher rd = request.getRequestDispatcher("adsCompleted.jsp");
